...
const Project = () => {
  ...
  const handleChange = (e) => {
    if (e.target.name === 'photo') {
      setProjects({ ...projects, photo: e.target.files[0] })
    } else {
  ...
  const formSubmit = async (e) => {
    ...
    try {
      setLoading(true)
      const imageUrl = await uploadToCloudinary(projects.photo)
          ...
          <div className="modalOverlay">
            <div className="modalContent">
              ...
              <form onSubmit={formSubmit}>
                ...
                <input type="file" placeholder='chose a photo' name="photo" id="photo" onChange={handleChange} required />
                ...
                <textarea style={{ fontFamily: 'sans-serif' }}
                  placeholder='Project describe' name='describe' value={projects.describe} onChange={handleChange} required />
